...
% Insert Locust overview + stats (Heavy A)
% \begin{figure}[h!] \centering
...
%   \caption{Light B --- Lambda Invocations (left), ConcurrentExecutions (middle), Duration (right).}
% \end{figure}
...
% Insert Locust vs Lambda side-by-side (optional)
% \begin{figure}[h!] \centering
...
% -------------------------
% Suggested figure insertions (filenames from your ZIP)
% A (Light):  lA - Charts.png, lA - Stats.png, lA - Duration.png, lA - ConcExecutions.png, lA - Invocations.png
% A (Heavy):  hA - Charts.png, hA- Stats.png, hA-Durations.png, hA-ConcEx.png, hA-Invocations.png
% B (Light):  lB - Charts.png, lB - Stats.png, lB - Duration.png, lB - ConcEx.png, lB - Invocations.png
% B (Heavy 1024MB): hB - Charts.png, hB - Stats.png, hB - Duration.png, hB - ConcEx.png, hB - Invocations.png
% B (Heavy 512MB):  hBl - Charts.png, hBl - Stats.png, hBl - Duration.png, hBl - ConcEx.png, hBl - Invocations.png
% C (Light):  lC - Charts.png, lC - Stats.png, lC  - Duration.png, lC  - ConcEx.png, lC - Invocations.png
% C (Heavy):  hC - Charts.png, hC - Stats.png, hC - Duration.png, hC - ConcEx.png, hC - Invocations.png
% -------------------------
